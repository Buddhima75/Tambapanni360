            ...
            <div class="right-image mobile">
               ...
               <div class="mobile-logo">
                  <a href="http://localhost/sl" id="branding-white" title="Tambapannni 361°"
                     ...
                     <img src="./images/logo/logo.png" alt="Tambapannni 361°"
                        ...
                        <div class="container">
                           <div class="row ">
                              <div class="col-md-3 text-center text-md-left align-items-center ">
                                 <img class="img-fluid" src="./images/logo/logo.png" alt="Tambapannni 361° Logo">
                              </div>
                              <div class="col-md-8 text-start">
                                 <p class="text-muted left ">
                                    Tambapannni 361° is a registered Sri Lankan travel agent specializing in tours of Sri Lanka and welcomes worldwide clients.
                                 </p>
                                 <p class="text-muted left">
                                    Having expertise as a tourism guide, Tambapannni 361° was initiated with the idea of providing reasonably priced tour packages of Sri Lanka, with flexibility that can be tailored for the individual traveler.
                                 </p>
                                 <p class="text-muted left">
                                 ...
                                 <p class="text-muted left">
                                    Tambapannni 361° encourages clients to relax and take in the beauty of Sri Lanka, learn about our history, and enjoy Sri Lanka’s delicious cuisine.
                                 </p>
                              </div>
                           </div>
                        </div>
                                    ...
                                    <div class="container1">
                                          ...
                                          <div class="review-items">
                                             ...
                                             <div class="review-item">
                                                ...
                                                <div class="comment">
                                                   <h5>The product was okay, but it didn’t meet all of my expectations.</h5>
                                                </div>
                                             </div>
                                             ...
                                             <div class="review-item">
                                                ...
                                                <div class="comment">
                                                   <h5>Not great, expected more features for the price.</h5>
                                                </div>
                                             </div>
                                             ...
                                             <div class="review-item">
                                                ...
                                                <div class="comment">
                                                   <h>Great item, but the color was a little different than expected.</h>
                                                </div>
                                             </div>
