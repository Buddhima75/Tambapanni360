                ...
                <div class="right-image mobile">
                    ...
                    <div class="mobile-logo">
                        <a href="http://localhost/sl" id="branding-white" title="Tambapannni 361°"
                            ...
                            <img src="../images/logo/logo2.png" alt="Tambapannni 361°"
                                title="Tambapannni 361°">
                        </a>
                    </div>
                </div>
                <div class="right-image desktop">
                    <div class="right-img-desktop" style="background-image:url('../images/vehicle/vehi.png')">
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="page-inner-wrapper">
                            <div class="component-page-intro intro-type-2">
                                <div class="title-main-wrapper listings">
                                    ...
                                    <h1 class="main-title apply-color ce">
                                ...
                                <div class="container">
                                    <p>We will provide suitable transport to our valued customers.</p>
                                    <p>Transportation is most important, so as to provide protection, time management, and a comfortable journey. Therefore, always use comfortable and appropriate vehicles for your tours. After finalizing a tour itinerary, we can select a vehicle that is suitable for your tour.</p>
                                    <p>It depends on the route and faxes of the tour or on your requirements. We can provide vehicles in the below-mentioned categories: cars, vans, minibusses, coaches, and any type of vehicle you require.</p>
                                </div>
                                ...
                                <div class="section-overview">
                                    ...
                                    <div class="left-content">
                                        ...
                                        <div class="cont">
                                            <p class="text-muted">Many of the world’s leading car models are used in our mode of transport for your convenience.</p>
                                            <p class="text-muted">We are also pleased to inform you that you can reserve the car of your choice for your special needs or special requests.</p>
