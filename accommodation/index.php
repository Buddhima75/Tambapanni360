                                    ...
                                    <div class="carousel-inner">
                                       <div class="carousel-item active">
                                          <div class="position-relative">
                                             <img src="../images/accommodation/cl.jpg" class="d-block w-100" alt="Tambapannni 361° Logo 1">
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="../images/accommodation/bl.jpg" class="d-block w-100" alt="Tambapannni 361° Logo 2">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="../images/accommodation/hk.webp" class="d-block w-100" alt="Tambapannni 361° Logo 3">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="../images/accommodation/sg.webp" class="d-block w-100" alt="Tambapannni 361° Logo 4">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                <h2>Shangri-La</h2>
                           ...
                           <div class="row py-3 ">
                              ...
                              <div class="col-12 mb-2">
                                 <div class="image-container msz">
                                    <img id="mainImage" src="../images/accommodation/ma.jpg"
                                       alt="Gallery image 1">
