...
<head>
   <title> Wildlife Tours in Sri Lanka | Tambapannni 361°
   </title>
         ...
         <div class="right-image-wrapper">
            ...
            <div class="right-image mobile">
               <div class="right-img-mobile"
                  style="background-image:url('http://localhost/sl/images/tours/h5 - Copy.jpg')">
               </div>
               <div class="right-img-ipad"
                  style="background-image:url('http://localhost/sl/images/tours/h5.jpg')">
               </div>
            ...
            <div class="right-image desktop">
               <div class="right-img-desktop" style="background-image:url('http://localhost/sl/images/tours/h5.jpg')">
               </div>
            </div>
         </div>
      </div>
                  ...
                  <div class="page-inner-wrapper">
                                 ...
                                 <div id="imageCarousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
                                    <div class="carousel-inner">
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="http://localhost/sl/images/tours/hab.webp" class="d-block w-100" alt="Tambapannni 361° Logo 2">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                <h2>Habarana</h2>
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="http://localhost/sl/images/tours/wil.jpg" class="d-block w-100" alt="Tambapannni 361° Logo 3">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                <h2>Wilpattu</h2>
                                       ...
                                       <div class="carousel-item">
                                          <div class="position-relative">
                                             <img src="http://localhost/sl/images/tours/156.jpg" class="d-block w-100" alt="Tambapannni 361° Logo 4">
                                             <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                                                <h2>Yala</h2>
                           ...
                           <div class="row py-3 ">
                              ...
                              <div class="col-12 mb-2">
                                 <div class="image-container msz">
                                    <img id="mainImage" src="http://localhost/sl/images/tours/156.jpg"
                                       alt="Gallery image 1">
                              ...
                              <div class="col-3 mt-1">
                                 <div class="image-container sz" onclick="changeImage(this)">
                                    <img src="http://localhost/sl/images/tours/156.jpg"
                                       data-text="Yala Safari" alt="Gallery image 1">
                                 </div>
                              </div>
                              <div class="col-3 mt-1">
                                 <div class="image-container sz" onclick="changeImage(this)">
                                    <img src="http://localhost/sl/images/tours/wil.jpg"
                              ...
                              <div class="col-3 mt-1">
                                 <div class="image-container sz" onclick="changeImage(this)">
                                    <img src="http://localhost/sl/images/tours/kau.webp"
                              ...
                              <div class="col-3 mt-1">
                                 <div class="image-container sz" onclick="changeImage(this)">
                                    <img src="http://localhost/sl/images/tours/1.jpg"
                        ...
                        <div class="eight-section-container">
                           ...
                           <div class="images-container">
                              <div class="hotel-image">
                                 ...
                                 <img src="http://localhost/sl/images/tours/ar.jpg" alt="Luxury Suite">
                                 <div class="hotel-title">Arrival</div>
                              </div>
                              <div class="hotel-image">
                                 <div class="hotel-number">2 Day</div>
                                 <img src="http://localhost/sl/images/tours/3.jpg" alt="Ocean View">
                              ...
                              <div class="hotel-image">
                                 ...
                                 <img src="http://localhost/sl/images/tours/ne.jpg" alt="City Hotel">
                                 <div class="hotel-title">Nuwara Eliya</div>
                              </div>
                              <div class="hotel-image">
                              ...
                              <div class="hotel-image">
                                 ...
                                 <img src="http://localhost/sl/images/tours/43.jpg" alt="Boutique Hotel">
                                 <div class="hotel-title">Colombo</div>
                              </div>
                              <div class="hotel-image">
                                 <div class="hotel-number">6 Day</div>
                                 <img src="http://localhost/sl/images/tours/7.jpg" alt="Heritage Hotel">
                                 <div class="hotel-title"> Yala</div>
                              </div>
                              <div class="hotel-image">
                                 <div class="hotel-number">5 Day</div>
                                 <img src="http://localhost/sl/images/tours/thi.jpg" alt="Beach Resort">
                     ...
                     <div id="carouselVideoExample" class="carousel slide carousel-fade" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner">
                           <!-- Single item -->
                           <div class="carousel-item active">
                              <img src="http://localhost/sl/images/accommodation/sg.webp" class="d-block w-100 op1" alt="First Slide">
                           ...
                           <!-- Single item -->
                           <div class="carousel-item">
                              <img src="http://localhost/sl/images/accommodation/hs.jpg" class="d-block w-100 op1" alt="Second Slide">
                              <div class="carousel-caption d-none d-md-block">
                           ...
                           <!-- Single item -->
                           <div class="carousel-item">
                              <img src="http://localhost/sl/images/tours/tea.jpg" class="d-block w-100 op1" alt="Third Slide">
                              <div class="carousel-caption d-none d-md-block">
